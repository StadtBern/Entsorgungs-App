...
// View to edit one active image on which all data except the ID can be edited
    ...
    return (
      <div class="edit-form">
        ...
        <form>
          ...
          <div className="form-group">
            <label htmlFor="altTxt">Alternativer Text</label>
            <input
              type="text"
              className="form-control"
              id="altTxt"
              value={this.state.altText}
              onChange={this.onChange.bind(this, 'altText')}
            />
          </div>
          <div className="form-group">
            ...
            >
              <option value="bild" selected={this.state.type == 'bild'}>
                Bild
              </option>
              <option
                value="fotopiktogramm"
                selected={this.state.type == 'fotopiktogramm'}
              >
                Fotopiktogramm
              </option>
              <option
                value="vektorpiktogramm"
                selected={this.state.type == 'vektorpiktogramm'}
              >
                Vektorpiktogramm
              </option>
            </select>
