...
// Page to list all static images on which only the metadata can be edited
...
export default class ImagesList extends Component {
  ...
  componentDidMount = async () => {
    const response = await fetch('/api/test/images?viewCategory=static')
          ...
          <div class="col-md-6">
            {current_image ? (
              <div>
                ...
                <Link
                  to={`/images-static/${current_image.id}`}
