...
// Page to list all archived images on which no data except the category can be edited
...
export default class ImagesList extends Component {
  ...
  componentDidMount = async () => {
    const response = await fetch('/api/test/images?viewCategory=archive')
          ...
          <div class="col-md-6">
            {current_image ? (
              <div>
                ...
                <Link
                  to={`/images-archiv/${current_image.id}`}
